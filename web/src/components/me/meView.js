...
export default class MeView extends React.Component {
            ...
            <Webcam
              ...
              onUserMedia={() => {
                if (this.props.requestAutomaticScreenshot && this.props.cameraIsActive) {
                  ...
                  this.takeScreenshotTask = setTimeout(
                    takeScreenshot(this.refs.webcam, this.props.roomId, this.props.user),
                    5000
                  )
                }
              }}
  ...
  _scheduleAutomaticPhotos(cameraModeId, cameraModes) {
    ...
    if (
      !cameraModeSelection ||
      cameraModeSelection.id === 'missing' ||
      !cameraModeSelection.interval ||
      cameraModeSelection.interval <= 0
    ) {
      return
    }
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      prevProps.cameraModeSelectionId !== this.props.cameraModeSelectionId ||
